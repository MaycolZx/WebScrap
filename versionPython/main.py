...
numerPage = 1
#Lista de valores
values = [["Product-Vendor"],["Product-Name"],["Price-Deposit"],["Sale"],["Price-Credit-Card"],["Price-Compare"]]
while nextSignal:
    ...
    for i in elementos:
        ...
        nameProduct = i.find('h5',class_ = "product-name balance-row-3").get_text(strip=True)
        ...
        priceCard = i.find('div',class_="price-no-discount price-credit-card").get_text(strip=True)
